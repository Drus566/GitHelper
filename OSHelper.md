...
* символьные (или потоковые, они же байт-ориентированные) (терминал, звуковая карта, принтер...). Существует ряд символьных псевдоустройств, не имеющих физического воплощения. Например в устройство `/dev/null` можно записать любую информацию, которая попросту игнорируется. Попытка читать из этого файла приведет к ситуации конец файла.
* блочные (блок-ориентированные)
