...
### Изменение в кавычках 
```
c(change)i(inner)'(кавычки или любой другой символ в котором находится слово)
```

### *Linux BIBLE*
Чтобы ввести команды Shella в Vim необходимо ввести:
```
:!<command>
```
К тому же есть интересная команда для выхода в Shell из Vim:
```
:!bash
```
Далее можно ввести нужны команды в терминале и вернутся обратно в Vim командой `exit`.
### Показывает последнюю редактированную строку 
```
Ctrl + G
```
